...
import { b as asyncDataDefaults, c as useNuxtApp, d as createError, a as useRuntimeConfig } from './server.mjs';
import { B as withLeadingSlash, n as joinURL, z as withoutTrailingSlash, C as withBase, A as hash } from '../runtime.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-Dmof2BE8.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-D-R6QGBs.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DhOk0kxZ.mjs.map
