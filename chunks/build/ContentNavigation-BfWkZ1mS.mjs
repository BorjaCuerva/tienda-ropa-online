import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DhOk0kxZ.mjs';
import { c as useNuxtApp, a as useRuntimeConfig } from './server.mjs';
import { A as hash } from '../runtime.mjs';
import { u as useContentPreview } from './preview-Dmof2BE8.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-D-R6QGBs.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BfWkZ1mS.mjs.map
